                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                Jumlah Pohon</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_pohon; ?></div>
                        </div>
                        <div class="col-auto">
...
<div class="col-md-12">
    <div class="card shadow mb-4">
        ...
        <div class="card-footer text-md-right">
            <a href="<?= base_url("petugas/beranda/ubahprofile/$purchasing[id_user]") ?>" class="btn btn-primary btn-icon btn-icon-split btn-sm">
