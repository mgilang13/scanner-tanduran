            ...
            <li class="nav-item ">
                ...
                <div id="managemenbarang" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="<?= base_url('petugas/scan'); ?>">Scan QR Code</a>
                        <a class="collapse-item" href="<?= base_url('petugas/manajemenpohon'); ?>">Penanaman</a>
                        <!-- <a class="collapse-item" href="<?= base_url('petugas/kategori'); ?>">Pemupukan</a> -->
                    </div>
                </div>
            </li>
            <!-- Nav Item -Supplier-->
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <?php $purchasing = $this->session->userdata('petugas'); ?>
